    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-secondary-600 mb-6">
          Oversee all agencies, view analytics, and manage system-wide settings.
        </p>
      </div>
          ...
          <Card>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4">
                ...
                <h4 className="font-medium text-secondary-800">Analytics Dashboard</h4>
                <p className="text-sm text-secondary-600">Track platform-wide performance</p>
              </div>
              <div className="text-center p-4">
                <span className="text-3xl mb-2 block">🏢</span>
                <h4 className="font-medium text-secondary-800">Agency Management</h4>
                <p className="text-sm text-secondary-600">Approve and manage agencies</p>
              </div>
              <div className="text-center p-4">
                <span className="text-3xl mb-2 block">⚙️</span>
                <h4 className="font-medium text-secondary-800">System Settings</h4>
                <p className="text-sm text-secondary-600">Configure platform options</p>
              </div>
            </div>
          </Card>
        </div>
